...
function generateSystemPrompt(data: any): string {
  ...
  const lines = [
    ...
    "",
    "NOME DEL CLIENTE:",
    "21. Usa SOLO il nome che il cliente ti dice. NON inventare mai un cognome.",
    "22. Se il cliente dice 'Marco', il nome e 'Marco'. Non aggiungere cognomi.",
    "23. Se hai bisogno del cognome, CHIEDI: 'Mi dici anche il cognome?'",
    "",
    "PRONUNCIA E LINGUA:",
    "24. Parla SEMPRE in italiano corretto. Mai parole inventate, mai parole in inglese.",
